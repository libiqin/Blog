...
虽说，我此前确实已经口头或简短的话语里「孵化」出身边几个朋友的公众号，但这步骤要落实到黑纸白字上，于我而言，其实还是困难的。
...
所以，我并非一个很好的运营者，但其中的思路，可以略微谈一谈，不专业不准确之处，可以指出和讨论。另外，考虑到这可能会是给神秘嘉宾的从零开始的教程，文章会从最基础的开始讲。如果已经有了这部分基础，可以往后翻，略过「基础知识」部分。文章整体包括：
「以下介绍包括公司和个人号」
...
你会希望吸引的人，对你真正感兴趣，而不是今天一时兴起关注，过几天取关，看着取关，其实有点小难过，却也不必过于执着。言为心声，这样便好。
...
到现在，博客的文章标题，几乎都是简单的书名了。但这和我自己的定位也有关系，这是后花园、自留地，不做宣传推广用。也加上，现在的心态倒是越发平静了，总觉得不必过于勉强，随意就好。能看到的，都是缘分。
...
具体的标题吸睛方法，如有兴趣，可自行网上搜索，有的是科学道理，有的比较造作，可以甄别一下，选择性应用。
...
在这里放上二维码，可大大便利新人关注你。如果觉得单放二维码太丑，可以制作卡片，左边二维码，右边写你的公众号介绍，排版字体等等，自行研究，记得加上一句引导语「长按扫描关注」等类似的话，不要忽视这句话的作用，人脑是很懒的，需要指令。
...
如果你的内容比较多样化，可以考虑**建设成不同的栏目**。当然，刚开始建立公众号，你对于栏目规划还没有那么清晰的思路，但可以先有这样一个概念和思考方向，后期不断增补完善。如果以往的积累已经比较多，也可以现在就尝试把文章分类。
...
什么情况下会用到素材管理部分的「图片、语音、视频」，点击相应部分，进行操作，来直接上传素材呢？一般是用于群发消息不发图文，而是直接引用这些信息的时候，或者是用于菜单栏目中「菜单建设在下一节讲 后台里也可以多摸索」。
